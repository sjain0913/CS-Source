 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Joshua Donegal");
		  toPrint += p1.toString("jdonegal3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Ritesh");
		  toPrint += p2.toString("rmalpani8");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Colton");
		  toPrint += p3.toString("chazelton3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Saumya Jain");
                  toPrint += p4.toString("sjain395");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Pritish Tarafdar");
                  toPrint += p5.toString("903437356");
